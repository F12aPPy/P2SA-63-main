...
func (pu *PatientUpdate) AddAntenatalIDs(ids ...int) *PatientUpdate {
	pu.mutation.AddAntenatalIDs(ids...)
	return pu
}

// AddAntenatals adds the antenatals edges to Antenatal.
func (pu *PatientUpdate) AddAntenatals(a ...*Antenatal) *PatientUpdate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return pu.AddAntenatalIDs(ids...)
}
...
func (pu *PatientUpdate) RemoveAntenatalIDs(ids ...int) *PatientUpdate {
	pu.mutation.RemoveAntenatalIDs(ids...)
	return pu
}

// RemoveAntenatals removes antenatals edges to Antenatal.
func (pu *PatientUpdate) RemoveAntenatals(a ...*Antenatal) *PatientUpdate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return pu.RemoveAntenatalIDs(ids...)
}
...
func (pu *PatientUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := pu.mutation.RemovedAntenatalsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   patient.AntenatalsTable,
			Columns: []string{patient.AntenatalsColumn},
			Bidi:    false,
	...
	if nodes := pu.mutation.AntenatalsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   patient.AntenatalsTable,
...
// AddAntenatalIDs adds the antenatals edge to Antenatal by ids.
func (puo *PatientUpdateOne) AddAntenatalIDs(ids ...int) *PatientUpdateOne {
	puo.mutation.AddAntenatalIDs(ids...)
	return puo
}

// AddAntenatals adds the antenatals edges to Antenatal.
func (puo *PatientUpdateOne) AddAntenatals(a ...*Antenatal) *PatientUpdateOne {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return puo.AddAntenatalIDs(ids...)
}
...
// RemoveAntenatalIDs removes the antenatals edge to Antenatal by ids.
func (puo *PatientUpdateOne) RemoveAntenatalIDs(ids ...int) *PatientUpdateOne {
	puo.mutation.RemoveAntenatalIDs(ids...)
	return puo
}

// RemoveAntenatals removes antenatals edges to Antenatal.
func (puo *PatientUpdateOne) RemoveAntenatals(a ...*Antenatal) *PatientUpdateOne {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return puo.RemoveAntenatalIDs(ids...)
}
...
func (puo *PatientUpdateOne) sqlSave(ctx context.Context) (pa *Patient, err error) {
	...
	if nodes := puo.mutation.RemovedAntenatalsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   patient.AntenatalsTable,
	...
	if nodes := puo.mutation.AntenatalsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   patient.AntenatalsTable,
