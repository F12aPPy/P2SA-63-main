...
// QueryUser queries the user edge of a Antenatal.
func (c *AntenatalClient) QueryUser(a *Antenatal) *UserQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, antenatal.UserTable, antenatal.UserColumn),
		)
...
// QueryPatient queries the patient edge of a Antenatal.
func (c *AntenatalClient) QueryPatient(a *Antenatal) *PatientQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, antenatal.PatientTable, antenatal.PatientColumn),
		)
		fromV = sqlgraph.Neighbors(a.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryBabystatus queries the babystatus edge of a Antenatal.
func (c *AntenatalClient) QueryBabystatus(a *Antenatal) *BabystatusQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, antenatal.BabystatusTable, antenatal.BabystatusColumn),
		)
		fromV = sqlgraph.Neighbors(a.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryAntenatals queries the antenatals edge of a Babystatus.
func (c *BabystatusClient) QueryAntenatals(b *Babystatus) *AntenatalQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, false, babystatus.AntenatalsTable, babystatus.AntenatalsColumn),
		)
...
// QueryAntenatals queries the antenatals edge of a Patient.
func (c *PatientClient) QueryAntenatals(pa *Patient) *AntenatalQuery {
	query := &AntenatalQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := pa.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(antenatal.Table, antenatal.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, patient.AntenatalsTable, patient.AntenatalsColumn),
		)
...
// QueryAntenatals queries the antenatals edge of a User.
func (c *UserClient) QueryAntenatals(u *User) *AntenatalQuery {
	query := &AntenatalQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(antenatal.Table, antenatal.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, user.AntenatalsTable, user.AntenatalsColumn),
		)
