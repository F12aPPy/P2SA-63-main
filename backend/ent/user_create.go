...
func (uc *UserCreate) AddAntenatalIDs(ids ...int) *UserCreate {
	uc.mutation.AddAntenatalIDs(ids...)
	return uc
}

// AddAntenatals adds the antenatals edges to Antenatal.
func (uc *UserCreate) AddAntenatals(a ...*Antenatal) *UserCreate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return uc.AddAntenatalIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.AntenatalsIDs(); len(nodes) > 0 {
