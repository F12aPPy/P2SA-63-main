...
func (uq *UserQuery) QueryAntenatals() *AntenatalQuery {
...
func (uq *UserQuery) WithAntenatals(opts ...func(*AntenatalQuery)) *UserQuery {
	query := &AntenatalQuery{config: uq.config}
	for _, opt := range opts {
		opt(query)
	}
	uq.withAntenatals = query
	return uq
}
...
func (uq *UserQuery) sqlAll(ctx context.Context) ([]*User, error) {
	...
	if query := uq.withAntenatals; query != nil {
		...
		query.Where(predicate.Antenatal(func(s *sql.Selector) {
			s.Where(sql.InValues(user.AntenatalsColumn, fks...))
		}))
