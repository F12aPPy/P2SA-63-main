...
func (e PatientEdges) AntenatalsOrErr() ([]*Antenatal, error) {
	if e.loadedTypes[0] {
...
// QueryAntenatals queries the antenatals edge of the Patient.
func (pa *Patient) QueryAntenatals() *AntenatalQuery {
	return (&PatientClient{config: pa.config}).QueryAntenatals(pa)
}
