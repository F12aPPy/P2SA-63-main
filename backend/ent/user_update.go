...
func (uu *UserUpdate) AddAntenatalIDs(ids ...int) *UserUpdate {
	uu.mutation.AddAntenatalIDs(ids...)
	return uu
}

// AddAntenatals adds the antenatals edges to Antenatal.
func (uu *UserUpdate) AddAntenatals(a ...*Antenatal) *UserUpdate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return uu.AddAntenatalIDs(ids...)
}
...
func (uu *UserUpdate) RemoveAntenatalIDs(ids ...int) *UserUpdate {
	uu.mutation.RemoveAntenatalIDs(ids...)
	return uu
}

// RemoveAntenatals removes antenatals edges to Antenatal.
func (uu *UserUpdate) RemoveAntenatals(a ...*Antenatal) *UserUpdate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return uu.RemoveAntenatalIDs(ids...)
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := uu.mutation.RemovedAntenatalsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.AntenatalsTable,
			Columns: []string{user.AntenatalsColumn},
			Bidi:    false,
	...
	if nodes := uu.mutation.AntenatalsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.AntenatalsTable,
...
// AddAntenatalIDs adds the antenatals edge to Antenatal by ids.
func (uuo *UserUpdateOne) AddAntenatalIDs(ids ...int) *UserUpdateOne {
	uuo.mutation.AddAntenatalIDs(ids...)
	return uuo
}

// AddAntenatals adds the antenatals edges to Antenatal.
func (uuo *UserUpdateOne) AddAntenatals(a ...*Antenatal) *UserUpdateOne {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return uuo.AddAntenatalIDs(ids...)
}
...
// RemoveAntenatalIDs removes the antenatals edge to Antenatal by ids.
func (uuo *UserUpdateOne) RemoveAntenatalIDs(ids ...int) *UserUpdateOne {
	uuo.mutation.RemoveAntenatalIDs(ids...)
	return uuo
}

// RemoveAntenatals removes antenatals edges to Antenatal.
func (uuo *UserUpdateOne) RemoveAntenatals(a ...*Antenatal) *UserUpdateOne {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return uuo.RemoveAntenatalIDs(ids...)
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (u *User, err error) {
	...
	if nodes := uuo.mutation.RemovedAntenatalsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.AntenatalsTable,
	...
	if nodes := uuo.mutation.AntenatalsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.AntenatalsTable,
